...
class ProductController extends AbstractController
{
    ...
    #[Route('/dash', name: 'app_product_indexdash', methods: ['GET'])]
    public function indexdash(ProductRepository $productRepository): Response
    {
        return $this->render('product/indexDash.html.twig', [
            'products' => $productRepository->findAll(),
        ]);
    }
